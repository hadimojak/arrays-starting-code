...
// // const persony = [{ name: "hadi" }, { name: "max" }, { name: "hai" }];

// // // const hai = persony.find((person, index, persons) => {
// // //   return person.name === "hai";
// // // });
// // // console.log(hai);

// // // const max = persony.findIndex((person, index, persons) => {
// // //   return person.name === "max";
// // // });
// // // console.log(max);

// // console.log(
// //   persony.filter((person, index, persons) => {
// //     return (person.name === "had");
// //   })
// // );

// const prices = [10.99, 4.5, 60, 35];
// let sum = 0;
// const sumPrice = prices.forEach((price, index, prices) => {
//   sum += price;
// });
// console.log(sum);
// const sumed = prices.reduce((preVal, curVal, curIdx, prices) => {
